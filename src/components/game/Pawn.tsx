...
export function Pawn({ player, r, c, isActive }: PawnProps) {
  // C = 100 / 11 = 9.0909%, G = 2.2727%
  ...
  return (
    <motion.div
      ...
      className={`absolute z-20 rounded-full shadow-lg border-[1.5px] ${
        player === 'p1' 
    ...
    >
      <div className="absolute top-[15%] left-[15%] w-[30%] h-[30%] rounded-full bg-white/20" />
    </motion.div>
  );
}
